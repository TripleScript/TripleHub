...
if executorName == "Solara" then
    local Notify = Library:MakeNotify({
        Title = "atriple HUB BY triple/FROSTLUA ",
        Text = "Triple HUB BY Triple and FROSTLUA  has determined that your executor, " .. executorName .. ", is fully compatible, ensuring an optimal and satisfying experience with our product.",
        Time = 5
      })
    ...
    local Notify = Library:MakeNotify({
        Title = "Triple HUB BY Triple and FROSTLUA ",
        Text = "triple HUB BY triple qnd  FROSTLUA  has determined that your executor, " .. executorName .. ", is fully compatible, ensuring an optimal and satisfying experience with our product.",
        Time = 5
      })
...
local Window = redzlib:MakeWindow({
    Title = "Triple HUB BY Triple and FROSTLUA  | " .. gameName,
    SubTitle = "by Triple and Belico2 and alexis.isback00",
    SaveFolder = "CRACKLED HUB BY yri "
})
...
Tab1:AddDiscordInvite({
    Name = "TRIPLE HUB BY TRIPLE AND FROSTLUA  Roblox",
    Logo = "rbxassetid://18884550772",
    Invite = "https://discord.gg/7suqb45QZk"
})
...
local function createNotification(player, deviceType)
    local Notify = Library:MakeNotify({
        Title = "Triple And Frostlua",
        Text = "Triple HUB BY triple/FROSTLUA  detected a rapid click on " .. player.Name .. "'s " .. deviceType,
        Time = 5
    })
end
...
setclipboard("https://discord.gg/7suqb45QZk")
